...
?>
<form class="form-signin" method="POST" action="index.php?controller=admin&action=logIn" role="form" style="width:300px" id="login_form">
        ...
        <button class="btn btn-lg btn-success btn-block" type="submit" value="Loguj">Log in</button>
</form>
<?php
	}
?>
